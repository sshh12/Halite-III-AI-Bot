...
class ShipyardAgent:
    ...
    def _update_observation(self):
        ...
        rel_mat = roll_to_position(self.shipyard, self.mat, crop=3)
    ...
    def _can_spawn(self):
        return self.game.me.halite_amount > constants.SHIP_COST
